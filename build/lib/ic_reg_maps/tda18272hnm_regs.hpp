/***********************************************************************
 * This file was generated by /home/mvnl-fancy/uhd-source_003.005.002-release/lib/ic_reg_maps/gen_tda18272hnm_regs.py on Mon May 18 16:53:13 2015
 **********************************************************************/
...
public:
    boost::uint8_t ident_14_8;
    boost::uint8_t ident_7_0;
    boost::uint8_t major_rev;
    boost::uint8_t minor_rev;
    boost::uint8_t tm_d;
    enum tm_on_t{
        TM_ON_SENSOR_OFF = 0,
        TM_ON_SENSOR_ON = 1
    ...
    boost::uint8_t lt_enable;
    boost::uint8_t agc1_6_15db;
    boost::uint8_t agc1_top;
    boost::uint8_t agc2_top;
    boost::uint8_t agcs_up_step_assym;
    boost::uint8_t agcs_up_step;
    ...
    boost::uint8_t rfagc_adapt_top;
    boost::uint8_t rfagc_low_bw;
    enum rf_atten_3db_t{
        RF_ATTEN_3DB_0DB = 0,
        RF_ATTEN_3DB_3DB = 1
    };
    rf_atten_3db_t rf_atten_3db;
    boost::uint8_t agc3_top;
    boost::uint8_t agc4_top;
    boost::uint8_t agcs_do_step_assym;
    enum agc5_hpf_t{
        AGC5_HPF_OFF = 0,
        AGC5_HPF_ON = 1
    };
    agc5_hpf_t agc5_hpf;
    boost::uint8_t agc5_top;
    enum if_level_t{
        IF_LEVEL_0_5VPP = 7,
        IF_LEVEL_0_6VPP = 6,
        IF_LEVEL_0_7VPP = 5,
    ...
    lp_fc_t lp_fc;
    boost::uint8_t i2c_clock_mode;
    enum digital_clock_t{
        DIGITAL_CLOCK_SPREAD_OFF = 0,
        DIGITAL_CLOCK_SPREAD_ON = 1
    };
    digital_clock_t digital_clock;
    boost::uint8_t xtalosc_anareg_en;
    enum xtout_t{
        XTOUT_NO = 0,
        XTOUT_16MHZ = 3
    };
    xtout_t xtout;
    boost::uint8_t if_freq;
    boost::uint8_t rf_freq_19_16;
    boost::uint8_t rf_freq_15_8;
    boost::uint8_t rf_freq_7_0;
    boost::uint8_t rssi_meas;
    boost::uint8_t rf_cal_av;
    boost::uint8_t rf_cal;
    boost::uint8_t ir_cal_loop;
    boost::uint8_t ir_cal_image;
    boost::uint8_t ir_cal_wanted;
    boost::uint8_t rc_cal;
    boost::uint8_t calc_pll;
    boost::uint8_t xtalcal_launch;
    boost::uint8_t msm_launch;
    boost::uint8_t psm_agc1;
    boost::uint8_t psm_stob;
    boost::uint8_t psmrfpoly;
    boost::uint8_t psm_mixer;
    boost::uint8_t psm_ifpoly;
    boost::uint8_t psm_lodriver;
    boost::uint8_t dcc_bypass;
    boost::uint8_t dcc_slow;
    boost::uint8_t dcc_psm;
    boost::uint8_t fmax_lo;
    boost::uint8_t ir_loop;
    boost::uint8_t ir_target;
    boost::uint8_t ir_gstep;
    boost::uint8_t ir_corr_boost;
    boost::uint8_t ir_freqlow_sel;
    boost::uint8_t ir_mode_ram_store;
    boost::uint8_t ir_freqlow;
    boost::uint8_t ir_freqmid;
    boost::uint8_t coarse_ir_freqhigh;
    boost::uint8_t ir_freqhigh;
    boost::uint8_t pd_vsync_mgt;
    boost::uint8_t pd_ovld;
    boost::uint8_t pd_udld;
    boost::uint8_t agc_ovld_top;
    boost::uint8_t agc_ovld_timer;
    boost::uint8_t ir_mixer_loop_off;
    boost::uint8_t ir_mixer_do_step;
    enum hi_pass_t{
        HI_PASS_DISABLE = 0,
        HI_PASS_ENABLE = 1
    };
    ...
    if_notch_t if_notch;
    boost::uint8_t agc1_loop_off;
    boost::uint8_t agc1_do_step;
    boost::uint8_t force_agc1_gain;
    boost::uint8_t agc1_gain;
    boost::uint8_t agc5_loop_off;
    boost::uint8_t agc5_do_step;
    boost::uint8_t force_agc5_gain;
    boost::uint8_t agc5_gain;
    boost::uint8_t rfcal_offset_cprog0;
    boost::uint8_t rfcal_freq0;
    boost::uint8_t rfcal_offset_cprog1;
    boost::uint8_t rfcal_freq1;
    boost::uint8_t rfcal_offset_cprog2;
    boost::uint8_t rfcal_freq2;
    boost::uint8_t rfcal_offset_cprog3;
    boost::uint8_t rfcal_freq3;
    boost::uint8_t rfcal_offset_cprog4;
    boost::uint8_t rfcal_freq4;
    boost::uint8_t rfcal_offset_cprog5;
    boost::uint8_t rfcal_freq5;
    boost::uint8_t rfcal_offset_cprog6;
    boost::uint8_t rfcal_freq6;
    boost::uint8_t rfcal_offset_cprog7;
    boost::uint8_t rfcal_freq7;
    boost::uint8_t rfcal_offset_cprog8;
    boost::uint8_t rfcal_freq8;
    boost::uint8_t rfcal_offset_cprog9;
    boost::uint8_t rfcal_freq9;
    boost::uint8_t rfcal_offset_cprog10;
    boost::uint8_t rfcal_freq10;
    boost::uint8_t rfcal_offset_cprog11;
    boost::uint8_t rfcal_freq11;
    boost::uint8_t rf_filter_bypass;
    boost::uint8_t agc2_loop_off;
    boost::uint8_t force_agc2_gain;
    boost::uint8_t rf_filter_gv;
    boost::uint8_t rf_filter_band;
    boost::uint8_t rf_filter_cap;
    boost::uint8_t agc2_do_step;
    boost::uint8_t gain_taper;
    boost::uint8_t rf_bpf_bypass;
    boost::uint8_t rf_bpf;
    boost::uint8_t n_cp_current;
    boost::uint8_t up_agc5;
    boost::uint8_t do_agc5;
    boost::uint8_t up_agc4;
    boost::uint8_t do_agc4;
    boost::uint8_t up_agc2;
    boost::uint8_t do_agc2;
    boost::uint8_t up_agc1;
    boost::uint8_t do_agc1;
    ...
    boost::uint8_t rssi;
    boost::uint8_t rssi_av;
    boost::uint8_t rssi_cap_reset_en;
    boost::uint8_t rssi_cap_val;
    boost::uint8_t rssi_ck_speed;
    boost::uint8_t rssi_dicho_not;
    boost::uint8_t rfcal_phi2;
    boost::uint8_t dds_polarity;
    boost::uint8_t rfcal_deltagain;
    enum irq_polarity_t{
        IRQ_POLARITY_RAISED_VCC = 0,
        IRQ_POLARITY_RAISED_LOW = 1
    };
    irq_polarity_t irq_polarity;
    boost::uint8_t rfcal_log_1;
    boost::uint8_t rfcal_log_2;
    boost::uint8_t rfcal_log_3;
    boost::uint8_t rfcal_log_4;
    boost::uint8_t rfcal_log_5;
    boost::uint8_t rfcal_log_6;
    boost::uint8_t rfcal_log_7;
    boost::uint8_t rfcal_log_8;
    boost::uint8_t rfcal_log_9;
    boost::uint8_t rfcal_log_10;
    boost::uint8_t rfcal_log_11;
    boost::uint8_t rfcal_log_12;
    enum magic_t{
        MAGIC_UNTOUCHED = 0,
    ...
    boost::uint8_t get_reg(boost::uint8_t addr){
        ...
        switch(addr){
        case 0:
            reg |= (boost::uint8_t(ident_14_8) & 0x7f) << 0;
            break;
        case 1:
            reg |= (boost::uint8_t(ident_7_0) & 0xff) << 0;
            break;
        case 2:
            reg |= (boost::uint8_t(major_rev) & 0xf) << 4;
            reg |= (boost::uint8_t(minor_rev) & 0xf) << 0;
            break;
        case 3:
            reg |= (boost::uint8_t(tm_d) & 0x7f) << 0;
            break;
        case 4:
            reg |= (boost::uint8_t(tm_on) & 0x1) << 0;
            break;
        case 5:
            reg |= (boost::uint8_t(por) & 0x1) << 1;
            reg |= (boost::uint8_t(lo_lock) & 0x1) << 0;
            break;
        case 6:
            reg |= (boost::uint8_t(sm) & 0x1) << 3;
            reg |= (boost::uint8_t(sm_pll) & 0x1) << 2;
            reg |= (boost::uint8_t(sm_lna) & 0x1) << 1;
            break;
        case 7:
            reg |= (boost::uint8_t(power_level) & 0x7f) << 0;
            break;
        case 8:
            reg |= (boost::uint8_t(irq_status) & 0x1) << 7;
            reg |= (boost::uint8_t(irq_xtalcal_end) & 0x1) << 5;
            reg |= (boost::uint8_t(irq_rssi_end) & 0x1) << 4;
            reg |= (boost::uint8_t(irq_localc_end) & 0x1) << 3;
            reg |= (boost::uint8_t(irq_rfcal_end) & 0x1) << 2;
            reg |= (boost::uint8_t(irq_ircal_end) & 0x1) << 1;
            reg |= (boost::uint8_t(irq_rccal_end) & 0x1) << 0;
            break;
        case 9:
            reg |= (boost::uint8_t(irq_enable) & 0x1) << 7;
            reg |= (boost::uint8_t(irq_xtalcal_enable) & 0x1) << 5;
            reg |= (boost::uint8_t(irq_rssi_enable) & 0x1) << 4;
            reg |= (boost::uint8_t(irq_localc_enable) & 0x1) << 3;
            reg |= (boost::uint8_t(irq_rfcal_enable) & 0x1) << 2;
            reg |= (boost::uint8_t(irq_ircal_enable) & 0x1) << 1;
            reg |= (boost::uint8_t(irq_rccal_enable) & 0x1) << 0;
            break;
        case 10:
            reg |= (boost::uint8_t(irq_clear) & 0x1) << 7;
            reg |= (boost::uint8_t(irq_xtalcal_clear) & 0x1) << 5;
            reg |= (boost::uint8_t(irq_rssi_clear) & 0x1) << 4;
            reg |= (boost::uint8_t(irq_localc_clear) & 0x1) << 3;
            reg |= (boost::uint8_t(irq_rfcal_clear) & 0x1) << 2;
            reg |= (boost::uint8_t(irq_ircal_clear) & 0x1) << 1;
            reg |= (boost::uint8_t(irq_rccal_clear) & 0x1) << 0;
            break;
        case 11:
            reg |= (boost::uint8_t(irq_set) & 0x1) << 7;
            reg |= (boost::uint8_t(irq_xtalcal_set) & 0x1) << 5;
            reg |= (boost::uint8_t(irq_rssi_set) & 0x1) << 4;
            reg |= (boost::uint8_t(irq_localc_set) & 0x1) << 3;
            reg |= (boost::uint8_t(irq_rfcal_set) & 0x1) << 2;
            reg |= (boost::uint8_t(irq_ircal_set) & 0x1) << 1;
            reg |= (boost::uint8_t(irq_rccal_set) & 0x1) << 0;
            break;
        case 12:
            reg |= (boost::uint8_t(lt_enable) & 0x1) << 7;
            reg |= (boost::uint8_t(agc1_6_15db) & 0x1) << 6;
            reg |= (boost::uint8_t(agc1_top) & 0xf) << 0;
            break;
        case 13:
            reg |= (boost::uint8_t(agc2_top) & 0x1f) << 0;
            break;
        case 14:
            reg |= (boost::uint8_t(agcs_up_step_assym) & 0x3) << 6;
            reg |= (boost::uint8_t(agcs_up_step) & 0x1) << 5;
            reg |= (boost::uint8_t(pulse_shaper_disable) & 0x1) << 4;
            reg |= (boost::uint8_t(agck_step) & 0x3) << 2;
            reg |= (boost::uint8_t(agck_mode) & 0x3) << 0;
            break;
        case 15:
            reg |= (boost::uint8_t(pd_rfagc_adapt) & 0x1) << 7;
            reg |= (boost::uint8_t(rfagc_adapt_top) & 0x3) << 5;
            reg |= (boost::uint8_t(rfagc_low_bw) & 0x1) << 4;
            reg |= (boost::uint8_t(rf_atten_3db) & 0x1) << 3;
            reg |= (boost::uint8_t(agc3_top) & 0x7) << 0;
            break;
        case 16:
            reg |= (boost::uint8_t(agc4_top) & 0xf) << 0;
            break;
        case 17:
            reg |= (boost::uint8_t(agcs_do_step_assym) & 0x3) << 5;
            reg |= (boost::uint8_t(agc5_hpf) & 0x1) << 4;
            reg |= (boost::uint8_t(agc5_top) & 0xf) << 0;
            break;
        case 18:
            reg |= (boost::uint8_t(if_level) & 0x7) << 0;
            break;
        case 19:
            reg |= (boost::uint8_t(if_hp_fc) & 0x3) << 6;
            reg |= (boost::uint8_t(if_atsc_notch) & 0x1) << 5;
            reg |= (boost::uint8_t(lp_fc_offset) & 0x3) << 3;
            reg |= (boost::uint8_t(lp_fc) & 0x7) << 0;
            break;
        case 20:
            reg |= (boost::uint8_t(i2c_clock_mode) & 0x1) << 7;
            reg |= (boost::uint8_t(digital_clock) & 0x1) << 6;
            reg |= (boost::uint8_t(xtalosc_anareg_en) & 0x1) << 4;
            reg |= (boost::uint8_t(xtout) & 0x3) << 0;
            break;
        case 21:
            reg |= (boost::uint8_t(if_freq) & 0xff) << 0;
            break;
        case 22:
            reg |= (boost::uint8_t(rf_freq_19_16) & 0xf) << 0;
            break;
        case 23:
            reg |= (boost::uint8_t(rf_freq_15_8) & 0xff) << 0;
            break;
        case 24:
            reg |= (boost::uint8_t(rf_freq_7_0) & 0xff) << 0;
            break;
        case 25:
            reg |= (boost::uint8_t(rssi_meas) & 0x1) << 7;
            reg |= (boost::uint8_t(rf_cal_av) & 0x1) << 6;
            reg |= (boost::uint8_t(rf_cal) & 0x1) << 5;
            reg |= (boost::uint8_t(ir_cal_loop) & 0x1) << 4;
            reg |= (boost::uint8_t(ir_cal_image) & 0x1) << 3;
            reg |= (boost::uint8_t(ir_cal_wanted) & 0x1) << 2;
            reg |= (boost::uint8_t(rc_cal) & 0x1) << 1;
            reg |= (boost::uint8_t(calc_pll) & 0x1) << 0;
            break;
        case 26:
            reg |= (boost::uint8_t(xtalcal_launch) & 0x1) << 1;
            reg |= (boost::uint8_t(msm_launch) & 0x1) << 0;
            break;
        case 27:
            reg |= (boost::uint8_t(psm_agc1) & 0x3) << 6;
            reg |= (boost::uint8_t(psm_stob) & 0x1) << 5;
            reg |= (boost::uint8_t(psmrfpoly) & 0x1) << 4;
            reg |= (boost::uint8_t(psm_mixer) & 0x1) << 3;
            reg |= (boost::uint8_t(psm_ifpoly) & 0x1) << 2;
            reg |= (boost::uint8_t(psm_lodriver) & 0x3) << 0;
            break;
        case 28:
            reg |= (boost::uint8_t(dcc_bypass) & 0x1) << 7;
            reg |= (boost::uint8_t(dcc_slow) & 0x1) << 6;
            reg |= (boost::uint8_t(dcc_psm) & 0x1) << 5;
            break;
        case 29:
            reg |= (boost::uint8_t(fmax_lo) & 0x3f) << 0;
            break;
        case 30:
            reg |= (boost::uint8_t(ir_loop) & 0x3) << 6;
            reg |= (boost::uint8_t(ir_target) & 0x7) << 3;
            reg |= (boost::uint8_t(ir_gstep) & 0x7) << 0;
            break;
        case 31:
            reg |= (boost::uint8_t(ir_corr_boost) & 0x1) << 7;
            reg |= (boost::uint8_t(ir_freqlow_sel) & 0x1) << 6;
            reg |= (boost::uint8_t(ir_mode_ram_store) & 0x1) << 5;
            reg |= (boost::uint8_t(ir_freqlow) & 0x1f) << 0;
            break;
        case 32:
            reg |= (boost::uint8_t(ir_freqmid) & 0x1f) << 0;
            break;
        case 33:
            reg |= (boost::uint8_t(coarse_ir_freqhigh) & 0x1) << 4;
            reg |= (boost::uint8_t(ir_freqhigh) & 0xf) << 0;
            break;
        case 34:
            reg |= (boost::uint8_t(pd_vsync_mgt) & 0x1) << 7;
            reg |= (boost::uint8_t(pd_ovld) & 0x1) << 6;
            reg |= (boost::uint8_t(pd_udld) & 0x1) << 5;
            reg |= (boost::uint8_t(agc_ovld_top) & 0x7) << 2;
            reg |= (boost::uint8_t(agc_ovld_timer) & 0x3) << 0;
            break;
        case 35:
            reg |= (boost::uint8_t(ir_mixer_loop_off) & 0x1) << 7;
            reg |= (boost::uint8_t(ir_mixer_do_step) & 0x3) << 5;
            reg |= (boost::uint8_t(hi_pass) & 0x1) << 1;
            reg |= (boost::uint8_t(if_notch) & 0x1) << 0;
            break;
        case 36:
            reg |= (boost::uint8_t(agc1_loop_off) & 0x1) << 7;
            reg |= (boost::uint8_t(agc1_do_step) & 0x3) << 5;
            reg |= (boost::uint8_t(force_agc1_gain) & 0x1) << 4;
            reg |= (boost::uint8_t(agc1_gain) & 0xf) << 0;
            break;
        case 37:
            reg |= (boost::uint8_t(agc5_loop_off) & 0x1) << 7;
            reg |= (boost::uint8_t(agc5_do_step) & 0x3) << 5;
            reg |= (boost::uint8_t(force_agc5_gain) & 0x1) << 3;
            reg |= (boost::uint8_t(agc5_gain) & 0x3) << 0;
            break;
        case 38:
            reg |= (boost::uint8_t(rfcal_offset_cprog0) & 0x3) << 6;
            reg |= (boost::uint8_t(rfcal_freq0) & 0x3) << 4;
            reg |= (boost::uint8_t(rfcal_offset_cprog1) & 0x3) << 2;
            reg |= (boost::uint8_t(rfcal_freq1) & 0x3) << 0;
            break;
        case 39:
            reg |= (boost::uint8_t(rfcal_offset_cprog2) & 0x3) << 6;
            reg |= (boost::uint8_t(rfcal_freq2) & 0x3) << 4;
            reg |= (boost::uint8_t(rfcal_offset_cprog3) & 0x3) << 2;
            reg |= (boost::uint8_t(rfcal_freq3) & 0x3) << 0;
            break;
        case 40:
            reg |= (boost::uint8_t(rfcal_offset_cprog4) & 0x3) << 6;
            reg |= (boost::uint8_t(rfcal_freq4) & 0x3) << 4;
            reg |= (boost::uint8_t(rfcal_offset_cprog5) & 0x3) << 2;
            reg |= (boost::uint8_t(rfcal_freq5) & 0x3) << 0;
            break;
        case 41:
            reg |= (boost::uint8_t(rfcal_offset_cprog6) & 0x3) << 6;
            reg |= (boost::uint8_t(rfcal_freq6) & 0x3) << 4;
            reg |= (boost::uint8_t(rfcal_offset_cprog7) & 0x3) << 2;
            reg |= (boost::uint8_t(rfcal_freq7) & 0x3) << 0;
            break;
        case 42:
            reg |= (boost::uint8_t(rfcal_offset_cprog8) & 0x3) << 6;
            reg |= (boost::uint8_t(rfcal_freq8) & 0x3) << 4;
            reg |= (boost::uint8_t(rfcal_offset_cprog9) & 0x3) << 2;
            reg |= (boost::uint8_t(rfcal_freq9) & 0x3) << 0;
            break;
        case 43:
            reg |= (boost::uint8_t(rfcal_offset_cprog10) & 0x3) << 6;
            reg |= (boost::uint8_t(rfcal_freq10) & 0x3) << 4;
            reg |= (boost::uint8_t(rfcal_offset_cprog11) & 0x3) << 2;
            reg |= (boost::uint8_t(rfcal_freq11) & 0x3) << 0;
            break;
        case 44:
            reg |= (boost::uint8_t(rf_filter_bypass) & 0x1) << 7;
            reg |= (boost::uint8_t(agc2_loop_off) & 0x1) << 5;
            reg |= (boost::uint8_t(force_agc2_gain) & 0x1) << 4;
            reg |= (boost::uint8_t(rf_filter_gv) & 0x3) << 2;
            reg |= (boost::uint8_t(rf_filter_band) & 0x3) << 0;
            break;
        case 45:
            reg |= (boost::uint8_t(rf_filter_cap) & 0xff) << 0;
            break;
        case 46:
            reg |= (boost::uint8_t(agc2_do_step) & 0x3) << 6;
            reg |= (boost::uint8_t(gain_taper) & 0x3f) << 0;
            break;
        case 47:
            reg |= (boost::uint8_t(rf_bpf_bypass) & 0x1) << 7;
            reg |= (boost::uint8_t(rf_bpf) & 0x7) << 0;
            break;
        case 48:
            reg |= (boost::uint8_t(n_cp_current) & 0x7f) << 0;
            break;
        case 49:
            reg |= (boost::uint8_t(up_agc5) & 0x1) << 7;
            reg |= (boost::uint8_t(do_agc5) & 0x1) << 6;
            reg |= (boost::uint8_t(up_agc4) & 0x1) << 5;
            reg |= (boost::uint8_t(do_agc4) & 0x1) << 4;
            reg |= (boost::uint8_t(up_agc2) & 0x1) << 3;
            reg |= (boost::uint8_t(do_agc2) & 0x1) << 2;
            reg |= (boost::uint8_t(up_agc1) & 0x1) << 1;
            reg |= (boost::uint8_t(do_agc1) & 0x1) << 0;
            break;
        case 50:
            reg |= (boost::uint8_t(agc2_gain_read) & 0x3) << 4;
            reg |= (boost::uint8_t(agc1_gain_read) & 0xf) << 0;
            break;
        case 51:
            reg |= (boost::uint8_t(top_agc3_read) & 0x7) << 0;
            break;
        case 52:
            reg |= (boost::uint8_t(agc5_gain_read) & 0x3) << 3;
            reg |= (boost::uint8_t(agc4_gain_read) & 0x7) << 0;
            break;
        case 53:
            reg |= (boost::uint8_t(rssi) & 0xff) << 0;
            break;
        case 54:
            reg |= (boost::uint8_t(rssi_av) & 0x1) << 5;
            reg |= (boost::uint8_t(rssi_cap_reset_en) & 0x1) << 3;
            reg |= (boost::uint8_t(rssi_cap_val) & 0x1) << 2;
            reg |= (boost::uint8_t(rssi_ck_speed) & 0x1) << 1;
            reg |= (boost::uint8_t(rssi_dicho_not) & 0x1) << 0;
            break;
        case 55:
            reg |= (boost::uint8_t(rfcal_phi2) & 0x3) << 6;
            reg |= (boost::uint8_t(dds_polarity) & 0x1) << 5;
            reg |= (boost::uint8_t(rfcal_deltagain) & 0xf) << 1;
            reg |= (boost::uint8_t(irq_polarity) & 0x1) << 0;
            break;
        case 56:
            reg |= (boost::uint8_t(rfcal_log_1) & 0xff) << 0;
            break;
        case 57:
            reg |= (boost::uint8_t(rfcal_log_2) & 0xff) << 0;
            break;
        case 58:
            reg |= (boost::uint8_t(rfcal_log_3) & 0xff) << 0;
            break;
        case 59:
            reg |= (boost::uint8_t(rfcal_log_4) & 0xff) << 0;
            break;
        case 60:
            reg |= (boost::uint8_t(rfcal_log_5) & 0xff) << 0;
            break;
        case 61:
            reg |= (boost::uint8_t(rfcal_log_6) & 0xff) << 0;
            break;
        case 62:
            reg |= (boost::uint8_t(rfcal_log_7) & 0xff) << 0;
            break;
        case 63:
            reg |= (boost::uint8_t(rfcal_log_8) & 0xff) << 0;
            break;
        case 64:
            reg |= (boost::uint8_t(rfcal_log_9) & 0xff) << 0;
            break;
        case 65:
            reg |= (boost::uint8_t(rfcal_log_10) & 0xff) << 0;
            break;
        case 66:
            reg |= (boost::uint8_t(rfcal_log_11) & 0xff) << 0;
            break;
        case 67:
            reg |= (boost::uint8_t(rfcal_log_12) & 0xff) << 0;
            reg |= (boost::uint8_t(magic) & 0x1) << 7;
            break;
        }
    ...
    void set_reg(boost::uint8_t addr, boost::uint8_t reg){
        switch(addr){
        case 0:
            ident_14_8 = boost::uint8_t((reg >> 0) & 0x7f);
            break;
        case 1:
            ident_7_0 = boost::uint8_t((reg >> 0) & 0xff);
            break;
        case 2:
            major_rev = boost::uint8_t((reg >> 4) & 0xf);
            minor_rev = boost::uint8_t((reg >> 0) & 0xf);
            break;
        case 3:
            tm_d = boost::uint8_t((reg >> 0) & 0x7f);
            break;
        case 4:
        ...
        case 6:
            ...
            break;
        case 7:
            power_level = boost::uint8_t((reg >> 0) & 0x7f);
            break;
        case 8:
        ...
        case 11:
            ...
            break;
        case 12:
            lt_enable = boost::uint8_t((reg >> 7) & 0x1);
            agc1_6_15db = boost::uint8_t((reg >> 6) & 0x1);
            agc1_top = boost::uint8_t((reg >> 0) & 0xf);
            break;
        case 13:
            agc2_top = boost::uint8_t((reg >> 0) & 0x1f);
            break;
        case 14:
            agcs_up_step_assym = boost::uint8_t((reg >> 6) & 0x3);
            agcs_up_step = boost::uint8_t((reg >> 5) & 0x1);
            pulse_shaper_disable = pulse_shaper_disable_t((reg >> 4) & 0x1);
            agck_step = boost::uint8_t((reg >> 2) & 0x3);
            agck_mode = agck_mode_t((reg >> 0) & 0x3);
            break;
        case 15:
            pd_rfagc_adapt = pd_rfagc_adapt_t((reg >> 7) & 0x1);
            rfagc_adapt_top = boost::uint8_t((reg >> 5) & 0x3);
            rfagc_low_bw = boost::uint8_t((reg >> 4) & 0x1);
            rf_atten_3db = rf_atten_3db_t((reg >> 3) & 0x1);
            agc3_top = boost::uint8_t((reg >> 0) & 0x7);
            break;
        case 16:
            agc4_top = boost::uint8_t((reg >> 0) & 0xf);
            break;
        case 17:
            agcs_do_step_assym = boost::uint8_t((reg >> 5) & 0x3);
            agc5_hpf = agc5_hpf_t((reg >> 4) & 0x1);
            agc5_top = boost::uint8_t((reg >> 0) & 0xf);
            break;
        case 18:
        ...
        case 19:
            ...
            break;
        case 20:
            i2c_clock_mode = boost::uint8_t((reg >> 7) & 0x1);
            digital_clock = digital_clock_t((reg >> 6) & 0x1);
            xtalosc_anareg_en = boost::uint8_t((reg >> 4) & 0x1);
            xtout = xtout_t((reg >> 0) & 0x3);
            break;
        case 21:
            if_freq = boost::uint8_t((reg >> 0) & 0xff);
            break;
        case 22:
            rf_freq_19_16 = boost::uint8_t((reg >> 0) & 0xf);
            break;
        case 23:
            rf_freq_15_8 = boost::uint8_t((reg >> 0) & 0xff);
            break;
        case 24:
            rf_freq_7_0 = boost::uint8_t((reg >> 0) & 0xff);
            break;
        case 25:
            rssi_meas = boost::uint8_t((reg >> 7) & 0x1);
            rf_cal_av = boost::uint8_t((reg >> 6) & 0x1);
            rf_cal = boost::uint8_t((reg >> 5) & 0x1);
            ir_cal_loop = boost::uint8_t((reg >> 4) & 0x1);
            ir_cal_image = boost::uint8_t((reg >> 3) & 0x1);
            ir_cal_wanted = boost::uint8_t((reg >> 2) & 0x1);
            rc_cal = boost::uint8_t((reg >> 1) & 0x1);
            calc_pll = boost::uint8_t((reg >> 0) & 0x1);
            break;
        case 26:
            xtalcal_launch = boost::uint8_t((reg >> 1) & 0x1);
            msm_launch = boost::uint8_t((reg >> 0) & 0x1);
            break;
        case 27:
            psm_agc1 = boost::uint8_t((reg >> 6) & 0x3);
            psm_stob = boost::uint8_t((reg >> 5) & 0x1);
            psmrfpoly = boost::uint8_t((reg >> 4) & 0x1);
            psm_mixer = boost::uint8_t((reg >> 3) & 0x1);
            psm_ifpoly = boost::uint8_t((reg >> 2) & 0x1);
            psm_lodriver = boost::uint8_t((reg >> 0) & 0x3);
            break;
        case 28:
            dcc_bypass = boost::uint8_t((reg >> 7) & 0x1);
            dcc_slow = boost::uint8_t((reg >> 6) & 0x1);
            dcc_psm = boost::uint8_t((reg >> 5) & 0x1);
            break;
        case 29:
            fmax_lo = boost::uint8_t((reg >> 0) & 0x3f);
            break;
        case 30:
            ir_loop = boost::uint8_t((reg >> 6) & 0x3);
            ir_target = boost::uint8_t((reg >> 3) & 0x7);
            ir_gstep = boost::uint8_t((reg >> 0) & 0x7);
            break;
        case 31:
            ir_corr_boost = boost::uint8_t((reg >> 7) & 0x1);
            ir_freqlow_sel = boost::uint8_t((reg >> 6) & 0x1);
            ir_mode_ram_store = boost::uint8_t((reg >> 5) & 0x1);
            ir_freqlow = boost::uint8_t((reg >> 0) & 0x1f);
            break;
        case 32:
            ir_freqmid = boost::uint8_t((reg >> 0) & 0x1f);
            break;
        case 33:
            coarse_ir_freqhigh = boost::uint8_t((reg >> 4) & 0x1);
            ir_freqhigh = boost::uint8_t((reg >> 0) & 0xf);
            break;
        case 34:
            pd_vsync_mgt = boost::uint8_t((reg >> 7) & 0x1);
            pd_ovld = boost::uint8_t((reg >> 6) & 0x1);
            pd_udld = boost::uint8_t((reg >> 5) & 0x1);
            agc_ovld_top = boost::uint8_t((reg >> 2) & 0x7);
            agc_ovld_timer = boost::uint8_t((reg >> 0) & 0x3);
            break;
        case 35:
            ir_mixer_loop_off = boost::uint8_t((reg >> 7) & 0x1);
            ir_mixer_do_step = boost::uint8_t((reg >> 5) & 0x3);
            hi_pass = hi_pass_t((reg >> 1) & 0x1);
            if_notch = if_notch_t((reg >> 0) & 0x1);
            break;
        case 36:
            agc1_loop_off = boost::uint8_t((reg >> 7) & 0x1);
            agc1_do_step = boost::uint8_t((reg >> 5) & 0x3);
            force_agc1_gain = boost::uint8_t((reg >> 4) & 0x1);
            agc1_gain = boost::uint8_t((reg >> 0) & 0xf);
            break;
        case 37:
            agc5_loop_off = boost::uint8_t((reg >> 7) & 0x1);
            agc5_do_step = boost::uint8_t((reg >> 5) & 0x3);
            force_agc5_gain = boost::uint8_t((reg >> 3) & 0x1);
            agc5_gain = boost::uint8_t((reg >> 0) & 0x3);
            break;
        case 38:
            rfcal_offset_cprog0 = boost::uint8_t((reg >> 6) & 0x3);
            rfcal_freq0 = boost::uint8_t((reg >> 4) & 0x3);
            rfcal_offset_cprog1 = boost::uint8_t((reg >> 2) & 0x3);
            rfcal_freq1 = boost::uint8_t((reg >> 0) & 0x3);
            break;
        case 39:
            rfcal_offset_cprog2 = boost::uint8_t((reg >> 6) & 0x3);
            rfcal_freq2 = boost::uint8_t((reg >> 4) & 0x3);
            rfcal_offset_cprog3 = boost::uint8_t((reg >> 2) & 0x3);
            rfcal_freq3 = boost::uint8_t((reg >> 0) & 0x3);
            break;
        case 40:
            rfcal_offset_cprog4 = boost::uint8_t((reg >> 6) & 0x3);
            rfcal_freq4 = boost::uint8_t((reg >> 4) & 0x3);
            rfcal_offset_cprog5 = boost::uint8_t((reg >> 2) & 0x3);
            rfcal_freq5 = boost::uint8_t((reg >> 0) & 0x3);
            break;
        case 41:
            rfcal_offset_cprog6 = boost::uint8_t((reg >> 6) & 0x3);
            rfcal_freq6 = boost::uint8_t((reg >> 4) & 0x3);
            rfcal_offset_cprog7 = boost::uint8_t((reg >> 2) & 0x3);
            rfcal_freq7 = boost::uint8_t((reg >> 0) & 0x3);
            break;
        case 42:
            rfcal_offset_cprog8 = boost::uint8_t((reg >> 6) & 0x3);
            rfcal_freq8 = boost::uint8_t((reg >> 4) & 0x3);
            rfcal_offset_cprog9 = boost::uint8_t((reg >> 2) & 0x3);
            rfcal_freq9 = boost::uint8_t((reg >> 0) & 0x3);
            break;
        case 43:
            rfcal_offset_cprog10 = boost::uint8_t((reg >> 6) & 0x3);
            rfcal_freq10 = boost::uint8_t((reg >> 4) & 0x3);
            rfcal_offset_cprog11 = boost::uint8_t((reg >> 2) & 0x3);
            rfcal_freq11 = boost::uint8_t((reg >> 0) & 0x3);
            break;
        case 44:
            rf_filter_bypass = boost::uint8_t((reg >> 7) & 0x1);
            agc2_loop_off = boost::uint8_t((reg >> 5) & 0x1);
            force_agc2_gain = boost::uint8_t((reg >> 4) & 0x1);
            rf_filter_gv = boost::uint8_t((reg >> 2) & 0x3);
            rf_filter_band = boost::uint8_t((reg >> 0) & 0x3);
            break;
        case 45:
            rf_filter_cap = boost::uint8_t((reg >> 0) & 0xff);
            break;
        case 46:
            agc2_do_step = boost::uint8_t((reg >> 6) & 0x3);
            gain_taper = boost::uint8_t((reg >> 0) & 0x3f);
            break;
        case 47:
            rf_bpf_bypass = boost::uint8_t((reg >> 7) & 0x1);
            rf_bpf = boost::uint8_t((reg >> 0) & 0x7);
            break;
        case 48:
            n_cp_current = boost::uint8_t((reg >> 0) & 0x7f);
            break;
        case 49:
            up_agc5 = boost::uint8_t((reg >> 7) & 0x1);
            do_agc5 = boost::uint8_t((reg >> 6) & 0x1);
            up_agc4 = boost::uint8_t((reg >> 5) & 0x1);
            do_agc4 = boost::uint8_t((reg >> 4) & 0x1);
            up_agc2 = boost::uint8_t((reg >> 3) & 0x1);
            do_agc2 = boost::uint8_t((reg >> 2) & 0x1);
            up_agc1 = boost::uint8_t((reg >> 1) & 0x1);
            do_agc1 = boost::uint8_t((reg >> 0) & 0x1);
            break;
        case 50:
        ...
        case 52:
            ...
            break;
        case 53:
            rssi = boost::uint8_t((reg >> 0) & 0xff);
            break;
        case 54:
            rssi_av = boost::uint8_t((reg >> 5) & 0x1);
            rssi_cap_reset_en = boost::uint8_t((reg >> 3) & 0x1);
            rssi_cap_val = boost::uint8_t((reg >> 2) & 0x1);
            rssi_ck_speed = boost::uint8_t((reg >> 1) & 0x1);
            rssi_dicho_not = boost::uint8_t((reg >> 0) & 0x1);
            break;
        case 55:
            rfcal_phi2 = boost::uint8_t((reg >> 6) & 0x3);
            dds_polarity = boost::uint8_t((reg >> 5) & 0x1);
            rfcal_deltagain = boost::uint8_t((reg >> 1) & 0xf);
            irq_polarity = irq_polarity_t((reg >> 0) & 0x1);
            break;
        case 56:
            rfcal_log_1 = boost::uint8_t((reg >> 0) & 0xff);
            break;
        case 57:
            rfcal_log_2 = boost::uint8_t((reg >> 0) & 0xff);
            break;
        case 58:
            rfcal_log_3 = boost::uint8_t((reg >> 0) & 0xff);
            break;
        case 59:
            rfcal_log_4 = boost::uint8_t((reg >> 0) & 0xff);
            break;
        case 60:
            rfcal_log_5 = boost::uint8_t((reg >> 0) & 0xff);
            break;
        case 61:
            rfcal_log_6 = boost::uint8_t((reg >> 0) & 0xff);
            break;
        case 62:
            rfcal_log_7 = boost::uint8_t((reg >> 0) & 0xff);
            break;
        case 63:
            rfcal_log_8 = boost::uint8_t((reg >> 0) & 0xff);
            break;
        case 64:
            rfcal_log_9 = boost::uint8_t((reg >> 0) & 0xff);
            break;
        case 65:
            rfcal_log_10 = boost::uint8_t((reg >> 0) & 0xff);
            break;
        case 66:
            rfcal_log_11 = boost::uint8_t((reg >> 0) & 0xff);
            break;
        case 67:
            rfcal_log_12 = boost::uint8_t((reg >> 0) & 0xff);
    ...
    boost::uint32_t get_rf_freq(void){
        return
        (boost::uint32_t(rf_freq_7_0 & 0xff) << 0) |
        (boost::uint32_t(rf_freq_15_8 & 0xff) << 8) |
        (boost::uint32_t(rf_freq_19_16 & 0xf) << 16) |
        0;
    }

    void set_rf_freq(boost::uint32_t reg){
