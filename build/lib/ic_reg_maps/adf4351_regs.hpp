/***********************************************************************
 * This file was generated by /home/mvnl-fancy/uhd-source_003.005.002-release/lib/ic_reg_maps/gen_adf4351_regs.py on Mon May 18 16:53:11 2015
 **********************************************************************/
...
public:
    ...
    boost::uint32_t get_reg(boost::uint8_t addr){
        ...
        case 1:
            ...
            reg |= (boost::uint32_t(phase_adjust) & 0x1) << 28;
            break;
        case 2:
        ...
        case 3:
            ...
            reg |= (boost::uint32_t(charge_cancel) & 0x1) << 21;
            reg |= (boost::uint32_t(anti_backlash_pulse) & 0x1) << 22;
            reg |= (boost::uint32_t(band_select_mode) & 0x1) << 23;
            break;
        case 4:
